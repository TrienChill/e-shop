...
export const ChatBox = ({ visible, onClose }: ChatBoxProps) => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: "assistant",
      content:
        "Xin chào! Tôi là trợ lý ảo của E-Shop. Tôi có thể giúp gì cho bạn hôm nay?",
      createdAt: new Date(),
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        ...
        role: "assistant",
        content:
          "Xin lỗi, hiện tại tôi không thể phản hồi. Vui lòng thử lại sau nhé.",
        createdAt: new Date(),
      };
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <MessageBubble
            ...
            isSlowLoading={item.id === "slow-indicator"}
          />
        )}
  ...
  if (Platform.OS === "web") {
    return <View style={styles.webContainer}>{renderContent()}</View>;
  }
